...
from utils.api_client import BaseAPIClient, _MAX_REDIRECT_HOPS
...
class TestRedirectSafety:
    ...
    def test_allow_redirects_is_disabled_on_the_initial_request(self, client):
        with patch('utils.api_client.requests.request', return_value=_make_response(200, 'http://radarr.local/api')) as mock_req:
