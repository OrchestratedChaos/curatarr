...
class TestFlattenCategorized:
    ...
    def test_flattens_other_services(self):
        ...
        categorized = {
            "user_services": {},
            "other_services": {"disney_plus": [{"title": "Movie 3", "tmdb_id": 3}]},
            "acquire": [],
        }
    ...
    def test_flattens_acquire(self):
        ...
        categorized = {"user_services": {}, "other_services": {}, "acquire": [{"title": "Rare Movie", "tmdb_id": 4}]}
    ...
    def test_flattens_all_items_as_list(self):
        ...
        categorized = {
            "all_items": [{"title": "All 1", "tmdb_id": 1}, {"title": "All 2", "tmdb_id": 2}],
            "user_services": {},
            "other_services": {},
            "acquire": [],
        }
    ...
    def test_empty_categorized(self):
        ...
        categorized = {"user_services": {}, "other_services": {}, "acquire": []}
...
class TestCollectImdbIds:
    ...
    def test_collects_ids_from_acquire(self, mock_get_imdb):
        ...
        categorized = {"user_services": {}, "other_services": {}, "acquire": [{"tmdb_id": 333}]}
    ...
    def test_skips_items_without_tmdb_id(self, mock_get_imdb):
        ...
        categorized = {"user_services": {"netflix": [{"title": "No ID"}]}, "other_services": {}, "acquire": []}
    ...
    def test_skips_failed_lookups(self, mock_get_imdb):
        ...
        categorized = {"user_services": {"netflix": [{"tmdb_id": 111}]}, "other_services": {}, "acquire": []}
...
class TestExportToRadarr:
    ...
    def test_skips_when_auto_sync_disabled(self):
        """Test skips export when auto_sync disabled."""
        config = {"radarr": {"enabled": True, "auto_sync": False}}
        all_users_data = []
...
class TestExportToSonarr:
    ...
    def test_skips_when_auto_sync_disabled(self):
        """Test skips export when auto_sync disabled."""
        config = {"sonarr": {"enabled": True, "auto_sync": False}}
        all_users_data = []
...
class TestExportToMdblist:
    ...
    def test_skips_when_auto_sync_disabled(self):
        """Test skips export when auto_sync disabled."""
        config = {"mdblist": {"enabled": True, "auto_sync": False}}
        all_users_data = []
...
class TestExportToSimkl:
    ...
    def test_skips_when_export_disabled(self):
        ...
        config = {"simkl": {"enabled": True, "export": {"enabled": False}}}
        all_users_data = []
    ...
    def test_skips_when_auto_sync_disabled(self):
        """Test skips export when auto_sync disabled."""
        config = {"simkl": {"enabled": True, "export": {"enabled": True, "auto_sync": False}}}
        all_users_data = []
...
class TestExportToRadarrNonCombinedMode:
    ...
    def test_root_folder_not_found_skips_library(self, mock_create, mock_create_from):
        ...
        mock_create_from.return_value = client
        config = {"radarr": {"enabled": True, "auto_sync": True, "user_mode": "per_user", "root_folder": "/movies"}}
        all_users_data = [
            {
                "username": "jason",
                "display_name": "Jason",
...
class TestExportToSonarrNonCombinedMode:
    ...
    def test_root_folder_not_found_skips_library(self, mock_create, mock_create_from):
        ...
        client.get_root_folders.return_value = [{"path": "/data"}]
        mock_create_from.return_value = client
        config = {"sonarr": {"enabled": True, "auto_sync": True, "user_mode": "per_user", "root_folder": "/tv"}}
        all_users_data = [
            {
                "username": "jason",
                "display_name": "Jason",
...
class TestExportToMdblistLogic:
    ...
    def test_replace_existing_false_skips_clear(self, mock_create):
        ...
        mock_create.return_value = client
        config = {"mdblist": {"enabled": True, "auto_sync": True, "user_mode": "per_user", "replace_existing": False}}
        all_users_data = [
            {
                "username": "jason",
                "display_name": "Jason",
