...
class TestTautulliClientCall:
    ...
    def test_call_success_unwraps_data(self, mock_request):
        ...
        mock_response.json.return_value = {"response": {"result": "success", "message": None, "data": [{"user_id": 1}]}}
    ...
    def test_call_error_result_raises(self, mock_request):
        ...
        mock_response.iter_content = Mock(return_value=[])
        mock_response.status_code = 200
        mock_response.json.return_value = {"response": {"result": "error", "message": "Invalid apikey", "data": {}}}
        mock_request.return_value = mock_response
...
class TestMapUsers:
    ...
    def test_matches_by_email(self):
        ...
        tautulli_users = [
            {"user_id": 501, "username": "jason_t", "friendly_name": "Jason T", "email": "jason@example.com"}
        ]
    ...
    def test_falls_back_to_friendly_name(self):
        ...
        tautulli_users = [
            {"user_id": 503, "username": "random_login", "friendly_name": "testuser_charlie", "email": None}
        ]
...
class TestFetchTautulliMovieHistory:
    ...
    def test_history_fetch_error_for_one_user_does_not_stop_others(self):
        ...
        result = fetch_tautulli_movie_history({}, ["1", "2"], client=client, user_map={"1": "100", "2": "200"})
...
class TestMergeShowWatchedData:
    ...
    def test_keeps_max_timestamp_per_show(self):
        ids, timestamps = merge_show_watched_data({1}, {1: 1000}, {1}, {1: 2000})
        assert timestamps == {1: 2000}

    def test_plex_timestamp_kept_when_newer(self):
        ids, timestamps = merge_show_watched_data({1}, {1: 5000}, {1}, {1: 2000})
