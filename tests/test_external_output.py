...
class TestGenerateCombinedHtml:
        ...
        all_users_data = [
            {
                ...
                "shows_categorized": {"all_items": [], "user_services": {}, "other_services": {}, "acquire": []},
            }
        ]

        with tempfile.TemporaryDirectory() as tmpdir:
            result = generate_combined_html(all_users_data, tmpdir, "api_key", self._mock_get_imdb_id)
    ...
    def test_includes_sequel_huntarr_tab_when_data_provided(self):
        all_users_data = [
            {
                "username": "testuser",
                "display_name": "TestUser",
                "movies_categorized": {"all_items": [], "user_services": {}, "other_services": {}, "acquire": []},
                "shows_categorized": {"all_items": [], "user_services": {}, "other_services": {}, "acquire": []},
                "user_services": [],
            }
        ]
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = generate_combined_html(
                all_users_data, tmpdir, "api_key", self._mock_get_imdb_id, missing_sequels=missing_sequels
            )
    ...
    def test_includes_horizon_huntarr_tab_when_data_provided(self):
        ...
        horizon_movies = [
            {
                "title": "Future Movie",
                "collection_name": "Future Collection",
                "tmdb_id": 789,
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = generate_combined_html(
                all_users_data, tmpdir, "api_key", self._mock_get_imdb_id, horizon_movies=horizon_movies
            )
    ...
    def test_handles_items_without_tmdb_id(self):
        ...
        horizon_movies = [
            {
                "title": "Future Without ID",
                "collection_name": "Future",
...
class TestGenerateMarkdown:
    ...
    def test_generates_markdown_file(self):
        ...
        movies_categorized = {
            ...
            "acquire": [
                {"title": "Movie C", "year": "2022", "rating": 7.0, "score": 0.70, "added_date": "2024-01-01T00:00:00"}
            ],
        }
        shows_categorized = {
            "user_services": {
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = generate_markdown("testuser", "TestUser", movies_categorized, shows_categorized, tmpdir)
    ...
    def test_empty_categories_skipped(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = generate_markdown("emptyuser", "EmptyUser", movies_categorized, shows_categorized, tmpdir)
    ...
    def test_library_suffix_qualifies_filename(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            result = generate_markdown(
                "testuser", "TestUser", movies_categorized, shows_categorized, tmpdir, library_suffix="_kids-movies"
            )
...
class TestHtmlEscaping:
    ...
    def test_malicious_horizon_status_is_escaped(self):
        horizon_movies = [
            {
                "title": "Normal Movie",
                "collection_name": "Normal Collection",
                "tmdb_id": 789,
                "release_date": "2026-06-15",
        ...
        all_users_data = [
            {
                ...
                "movies_categorized": {
                    "all_items": [
                        {
                            "title": "Tom & Jerry: It's a Wonderful Movie",
                            "year": "2024",
                            "rating": 7.0,
                            "score": 0.70,
                            "tmdb_id": 1,
