...
class TestTraktClientDiscoveryMethods:
    ...
    def test_get_trending_shows(self):
        ...
        mock_response = [
            {
                "watchers": 50,
                "show": {"title": "Test Show", "year": 2024, "ids": {"tmdb": 54321, "imdb": "tt7654321", "trakt": 222}},
            }
        ]
    ...
    def test_get_popular(self):
        ...
        mock_response = [{"title": "Popular Movie", "year": 2023, "ids": {"tmdb": 99999, "imdb": "tt9999999"}}]
    ...
    def test_get_anticipated(self):
        ...
        mock_response = [
            {"list_count": 5000, "movie": {"title": "Upcoming Movie", "year": 2025, "ids": {"tmdb": 88888}}}
        ]
    ...
    def test_get_recommendations_with_auth(self):
        ...
        client = TraktClient(client_id="test_id", client_secret="test_secret", access_token="valid_token")

        mock_response = [{"title": "Recommended Movie", "year": 2024, "ids": {"tmdb": 77777}}]
    ...
    def test_get_related(self):
        ...
        mock_response = [{"title": "Related Movie", "year": 2023, "ids": {"tmdb": 66666}}]
...
class TestDiscoveryCache:
    ...
    def test_load_stale_cache_returns_none(self, tmp_path):
        ...
        from utils.trakt_discovery import DISCOVERY_CACHE_TTL, _load_discovery_cache
...
class TestExtractItemIds:
    ...
    def test_extract_from_trending_format(self):
        ...
        item = {
            "watchers": 100,
            "movie": {"title": "Test Movie", "year": 2024, "ids": {"tmdb": 12345, "imdb": "tt1234567", "trakt": 111}},
        }
    ...
    def test_extract_from_popular_format(self):
        ...
        item = {"title": "Popular Movie", "year": 2023, "ids": {"tmdb": 99999, "imdb": "tt9999999"}}
    ...
    def test_extract_from_anticipated_format(self):
        ...
        item = {"list_count": 5000, "show": {"title": "Upcoming Show", "year": 2025, "ids": {"tmdb": 88888}}}
...
class TestDiscoverFromTrakt:
    ...
    def test_returns_empty_when_discovery_disabled(self):
        ...
        config = {
            "trakt": {"enabled": True, "client_id": "id", "client_secret": "secret", "discovery": {"enabled": False}}
        }
        result = discover_from_trakt(config, "movie", "/tmp/cache")
    ...
    def test_excludes_library_items(self, tmp_path):
        ...
        with (
            patch("utils.trakt_discovery.get_authenticated_trakt_client") as mock_client,
...
class TestGetTraktDiscoveryCandidates:
    ...
    def test_converts_to_candidate_format(self, mock_discover, tmp_path):
        ...
        mock_discover.return_value = {
            "trending": [{"tmdb_id": 123, "title": "Trending Movie", "year": 2024, "watchers": 100}],
            "popular": [],
            "anticipated": [],
            "recommendations": [],
        }
        ...
        result = get_trakt_discovery_candidates(config, "movie", str(tmp_path), library_tmdb_ids=set())
    ...
    def test_deduplicates_across_sources(self, mock_discover, tmp_path):
        ...
        mock_discover.return_value = {
            "trending": [{"tmdb_id": 123, "title": "Movie", "year": 2024}],
            "popular": [
...
class TestDiscoveryCacheVersioning:
    ...
    def test_load_cache_returns_data_for_current_version(self, tmp_path):
        ...
        from utils.trakt_discovery import TRAKT_DISCOVERY_CACHE_VERSION, _load_discovery_cache
    ...
    def test_save_cache_includes_version(self, tmp_path):
        ...
        from utils.trakt_discovery import TRAKT_DISCOVERY_CACHE_VERSION, _save_discovery_cache
    ...
    def test_load_cache_returns_none_for_missing_version(self, tmp_path):
        ...
        cache_data = {"cached_at": time.time(), "items": [{"tmdb_id": 456, "title": "Old Cache"}]}
        cache_path.write_text(json.dumps(cache_data))
...
class TestGetTrendingItems:
    ...
    def test_returns_cached_items(self, tmp_path):
        ...
        from utils.trakt_discovery import _save_discovery_cache, get_trending_items
    ...
    def test_fetches_from_api_when_no_cache(self, tmp_path):
        ...
        mock_client.get_trending.return_value = [
            {"watchers": 100, "movie": {"title": "API Movie", "year": 2024, "ids": {"tmdb": 456, "imdb": "tt456"}}}
        ]
...
class TestGetPopularItems:
    ...
    def test_returns_cached_items(self, tmp_path):
        """Test returns cached items when available."""
        from utils.trakt_discovery import _save_discovery_cache, get_popular_items
    ...
    def test_fetches_from_api_when_no_cache(self, tmp_path):
        ...
        mock_client.get_popular.return_value = [
            {"title": "Popular Movie", "year": 2024, "ids": {"tmdb": 456, "imdb": "tt456"}}
        ]
...
class TestGetAnticipatedItems:
    ...
    def test_returns_cached_items(self, tmp_path):
        """Test returns cached items when available."""
        from utils.trakt_discovery import _save_discovery_cache, get_anticipated_items
    ...
    def test_fetches_from_api_when_no_cache(self, tmp_path):
        ...
        mock_client.get_anticipated.return_value = [
            {"list_count": 5000, "movie": {"title": "Upcoming Movie", "year": 2025, "ids": {"tmdb": 789}}}
        ]
...
class TestGetRecommendedItems:
    ...
    def test_returns_cached_items_when_authenticated(self, tmp_path):
        ...
        from utils.trakt_discovery import _save_discovery_cache, get_recommended_items
    ...
    def test_fetches_from_api_when_authenticated(self, tmp_path):
        ...
        mock_client.get_recommendations.return_value = [
            {"title": "Recommended Movie", "year": 2024, "ids": {"tmdb": 999}}
        ]
...
class TestDiscoverFromTraktFallback:
    ...
    def test_returns_empty_when_no_client_available(self, mock_create, mock_auth, tmp_path):
        ...
        config = {
            "trakt": {"enabled": True, "client_id": "id", "client_secret": "secret", "discovery": {"enabled": True}}
        }
...
class TestDiscoverFromTraktFiltering:
    ...
    def test_filters_by_imdb_id(self, mock_trending, mock_client, tmp_path):
        ...
        result = discover_from_trakt(config, "movie", str(tmp_path), exclude_imdb_ids={"tt123"})
    ...
    def test_fetches_anticipated_when_enabled(self, mock_anticipated, mock_client, tmp_path):
        ...
        mock_client.return_value = Mock(is_authenticated=True)
        mock_anticipated.return_value = [{"tmdb_id": 789, "title": "Anticipated"}]
