...
#     find_missing_sequels/load_huntarr_cache/get_watch_providers/
#     get_collection_details moved to recommenders/huntarr.py (PR2 external.py
#     decomposition - see CHANGELOG), but tests/test_external.py and other
#     callers still import these from here, not recommenders.huntarr.
__all__ = [
    "sync_watch_history_to_trakt",
...
# Horizon Huntarr / external recs cache versions (Sequel Huntarr's own
# SEQUEL_HUNTARR_CACHE_VERSION/HUNTARR_CACHE_VERSION moved to
# recommenders/huntarr.py along with find_missing_sequels - see the
# recommenders.huntarr import above)
