...
from utils.trakt import TraktAPIError, TraktClient, get_authenticated_trakt_client
...
def _save_discovery_cache(cache_dir: str, source: str, media_type: str, items: List[Dict]):
    ...
    try:
        cache = {"version": TRAKT_DISCOVERY_CACHE_VERSION, "cached_at": time.time(), "items": items}
